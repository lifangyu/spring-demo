/**  
 * @(#)ConsumerFormAuthenticationFilter.java	  2016年7月10日 下午4:23:40
 *
 ...
 * @version V1.0
 */
public class ConsumerFormAuthenticationFilter extends FormAuthenticationFilter {
     ...
     */
    @Override
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {if (isLoginRequest(request, response)) {
            if (isLoginSubmission(request, response)) {
                ...
                if ("XMLHttpRequest".equalsIgnoreCase(((HttpServletRequest) request).getHeader("X-Requested-With"))) {// 不是ajax请求
                    ...
                    if (imageCode == null || "".equals(imageCode) || !vcode.equals(imageCode)) {
